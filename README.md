link do chat utilizado com as evidencias:
https://claude.ai/share/b555af33-a088-4925-8d64-b7f6b8f45174

Explique, de forma objetiva e organizada:
1. Por que decidiu utilizar IA nesta prova:
   
   Para entregar de forma mais Eficaz e com menos erros possiveis.

2. Para que utilizou a IA exatamente (ex.: estrutura inicial, correção de erro, geração de layout, explicação de
sintaxe, refatoração etc.);

  Para corrigir erros estruturais, organizar metodo de avisos, deixar mais agradavel
